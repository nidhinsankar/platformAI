        ...
        <Body className="bg-white my-auto mx-auto font-sans">
          <Container className="my-10 mx-auto p-5 w-[465px]">
            ...
            <Text className="text-sm">
              ...
              <span>{siteConfig.name}</span>. We hope you enjoy your journey
              with us. If you have any questions or need assistance, feel free
              to reach out.
            </Text>
            <Text>
              You can contact us directly with the email PlatformAI@gmail.com
            </Text>
            ...
            <Text className="text-center text-gray-400">
              You are subscribed to the marketing emails. To manage your
              communication preferences, click{" "}
              <Link
