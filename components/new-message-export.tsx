...
interface NewMessageExportFormProps
  extends React.HTMLAttributes<HTMLFormElement> {
  chatbots: Pick<Chatbot, "id" | "name">[];
}

export function NewMessageExportForm({
  chatbots,
  className,
  ...props
}: NewMessageExportFormProps) {
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  />
                  <FormDescription>
                    Export messages from the last X days. It can be any number
                    between 1 and 365.
                  </FormDescription>
                  <FormMessage />
                </FormItem>
