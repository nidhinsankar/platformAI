document.addEventListener("DOMContentLoaded", function () {
  ...
  var targetDiv = document.getElementById("PlatformAI-chatbot");
  if (!targetDiv) {
    console.error("Target div 'PlatformAI-chatbot' not found.");
    return;
  }
  ...
  iframe.src = `https://PlatformAI.io/embed/${chatbotId}/window?chatbox=false`;
  iframe.setAttribute(
    "style",
    `
    overflow: hidden;
