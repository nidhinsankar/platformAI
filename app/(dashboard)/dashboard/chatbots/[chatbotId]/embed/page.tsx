...
export default async function EmbedOnSitePage({
  params,
...
>
 ...
 <!-- This chatbot is build using https://PlatformAI.io/ -->
`}
            ></CodeBlock>
          </div>
        </TabsContent>
